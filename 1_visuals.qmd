...
# Active Attack Fact Sheet

## row 1

### row 1, column 1

::: {.card .flow title="Quick Statistics" expandable="false"}
...
::: {.card .flow title="Statistics" expandable="false"}
2000 - 2024 Active Attack Data

There have been **597** active attacks identified.

## Weapons

[Primary Weapon:]{.underline}

Firearm: [**557**]{.underline} (93.3%)

Blade: [**28**]{.underline} (4.7%)

Vehicle: [**12**]{.underline} (2%)

Multiple Weapons used in **30.7%** of events.

[Breakdown of Firearms:]{.underline}

Pistol: [**331**]{.underline} (59.4%)

Rifle: [**170**]{.underline} (30.5%)

Shotgun: [**49**]{.underline} (8.8%)

Unknown: [**7**]{.underline} (1.3%)

## Attackers

[Number of Attackers:]{.underline}

Part of an active attack can include spillover from a previously
excludable event, such as a gang attack. If an event begins as a gang
attack and the attacker(s) continue the killing process with unrelated
individuals, we include it as an active attack. As a result, we have a
small number of cases with multiple attackers.

1 Attacker: [**582**]{.underline} (97.5%)

2 Attackers: [**12**]{.underline} (2%)

3 Attackers: [**3**]{.underline} (0.5%)

[Race:]{.underline}

African American: [**175**]{.underline} (29.3%)

Asian: [**22**]{.underline} (3.7%)

Caucasian: [**282**]{.underline} (47.2%)

Latino: [**78**]{.underline}(13.1%)

Middle Eastern: [**16**]{.underline} (2.7%)

Other: [**4**]{.underline} (0.7%)

Unknown: [**20**]{.underline} (3.4%)

[Attacker/Victim Relationship:]{.underline}

No Relationship: [**388**]{.underline} (65%)

Employee/Former Employee: [**94**]{.underline} (15.7%)

Student/Former Student: [**67**]{.underline} (11.2%)

All Other: [**48**]{.underline} (8%)

## Locations

[Location of Attacks:]{.underline}

Business: [**269**]{.underline} (45.1%)

School: [**80**]{.underline} (13.4%)

Public/Outdoors: [**166**]{.underline} (27.8%)

Church: [**20**]{.underline} (3.4%)

Military Base: [**6**]{.underline} (1%)

All Other: [**56**]{.underline} (9.4%)

## Resolutions

Prior to LE Arrival (347 \[58.2%\])

            Shot by Civilian: [**27**]{.underline}(4.5%)

            Subdued by Civilian: [**53**]{.underline} (8.9%)

            Suicide before Police Arrival: [**81**]{.underline} (13.6%)

            Flee the Scene: [**186**]{.underline} (31.2%)

After LE Arrival (250 \[41.8%\])

            Shot by Police: [**132**]{.underline} (22.1%)

            Subdued by Police: [**54**]{.underline} (9%)

            Suicide after Police Arrival: [**47**]{.underline} (7.9%)

            Surrendered: [**17**]{.underline} (2.8%)

## Victims

Total: [**4055**]{.underline} (Median \# of Victims:
[**4**]{.underline})

Wounded: [**2640**]{.underline} (Median \# of Wounded:
[**2**]{.underline})

Killed: [**1415**]{.underline} (Median \# of Victims Killed:
[**1**]{.underline})
:::

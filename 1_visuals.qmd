...
(`{r} school_student_pct`%). Only a small percentage of attacks
(`{r} school_norel_pct`) on schools were perpetrated by an attacker with
...
{{< downloadthis data/aa_data_wide_codebook.docx dname="active_attack_data_v2023_codebook" >}}
Codebook (*.docx*)
:::

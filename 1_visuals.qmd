...
-   **2007**: The attack on Nov. 5th at Virginia Tech, Virginia, resulted in 
`{r} virginia_tech_total` deaths, accounting for 
`{r} virginia_tech_total_pct`% of all attacks that year.
-   **2009**: The attack at Fort Hood (now Fort Cavazos), Texas, resulted in 
`{r} fort_hood_total` deaths, accounting for `{r} fort_hood_total_pct`% of 
all attacks that year.
-   **2012**: The school shooting on Dec. 12th at Sandy Hook Elementary School, 

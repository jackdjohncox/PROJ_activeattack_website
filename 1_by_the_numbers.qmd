...
![{{< downloadthis www/univar_month.png >}}](www/univar_month.png)
:::

::: {.card .flow title="By Day of the Week" expandable="true"}
![{{< downloadthis www/univar_wday.png >}}](www/univar_wday.png)
:::
...
![{{< downloadthis www/univar_rel.png >}}](www/univar_rel.png)
:::

::: {.card .fill title="Location Type & Time of Day" expandable="true"}
![{{< downloadthis www/bivar_loc_hr.png >}}](www/bivar_loc_hr.png)
:::
...
![{{< downloadthis www/bivar_kill_yr.png >}}](www/bivar_kill_yr.png)
:::
...
![{{< downloadthis www/bicol_map_eventxkilled.png >}}](www/bicol_map_eventxkilled.png)
:::

::: {.card .flow title="Attacks from 2000-2023" expandable="true"}
![{{< downloadthis www/rolling_map.gif >}}](www/rolling_map.gif)
:::
...
::: {.card .flow title="About the Data" expandable="false"}
The data are in "long format", meaning that there is one row per shooter (not 
per event). Events with more than one shooter will have multiple rows. Use the 
"case_code" variable to avoid double or triple counting cases. You can 
download the data by clicking the "download" button below.

**Long Format** {{< downloadthis data/aa_data_clean_nogeo_2023.rds >}}  

If you prefer "wide format", meaning that each row represents a unique event, 
then use the "download" button below.

**Wide Format** {{< downloadthis data/aa_data_clean_nogeo_2023.rds >}}
:::
